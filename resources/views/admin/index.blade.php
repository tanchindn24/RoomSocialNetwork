                    ...
                    <div class="card profile-greeting">
                        <div class="card-body pb-0">
                            ...
                            <div class="cartoon"><img class="img-fluid"
                                                      src="assets/backend/admin/assets/images/dashboard/cartoon.png"
                                                      alt=""></div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row m-0">
                                <div class="col-xl-3 earning-content p-0">
                                    <div class="row m-0 chart-left">
                                        ...
                                        <div class="col-xl-12 p-0 left-btn"><a class="btn btn-gradient">Summary</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-9 p-0">
                                    ...
                                    <div class="row border-top m-0">
                                        ...
                                        <div class="col-xl-4 col-md-12 pe-0">
                                            <div class="media p-0">
                                                <div class="media-left"><i class="icofont icofont-cur-dollar"></i>
                                                </div>
                                                <div class="media-body">
                    ...
                    <div class="card">
                                ...
                                <div class="card-header-right-icon">
                                    <div class="dropdown">
                                        <button class="btn dropdown-toggle" id="dropdownMenuButton" type="button"
                                                data-bs-toggle="dropdown" aria-expanded="false">Today
                                        </button>
                                        <div class="dropdown-menu dropdown-menu-end"
                                             aria-labelledby="dropdownMenuButton"><a class="dropdown-item" href="#">Today</a><a
                                                class="dropdown-item" href="#">Tomorrow</a><a class="dropdown-item"
                                                                                              href="#">Yesterday</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="news-update media"><img class="img-fluid me-3 b-r-10"
                                                                src="assets/backend/admin/assets/images/dashboard/update/1.jpg"
                                                                alt="">
                                <div class="media-body">
                                    <h6>36% off For pixel Couslations Types.</h6><span>Lorem Ipsum is simply dummy...</span><span
                                        class="time-detail d-block"><i
                                            data-feather="clock"></i>10 Minutes Ago</span>
                                </div>
                            </div>
                            <div class="news-update media"><img class="img-fluid me-3 b-r-10"
                                                                src="assets/backend/admin/assets/images/dashboard/update/2.jpg"
                                                                alt="">
                                <div class="media-body">
                                    <h6>We are produce new product this</h6><span> Lorem Ipsum is simply text of the printing... </span><span
                                        class="time-detail d-block"><i data-feather="clock"></i>1 Hour Ago</span>
                                </div>
                            </div>
                            <div class="news-update media"><img class="img-fluid me-3 b-r-10"
                                                                src="assets/backend/admin/assets/images/dashboard/update/3.jpg"
                                                                alt="">
                                <div class="media-body">
                                    <h6>50% off For COVID Couslations Types.</h6><span>Lorem Ipsum is simply dummy...</span><span
                                        class="time-detail d-block"><i data-feather="clock"></i>8 Hours Ago</span>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <table class="table table-bordernone">
                                            ...
                                            <tr>
                                                <td><img class="img-fluid img-40 rounded-circle mb-3"
                                                         src="assets/backend/admin/assets/images/appointment/app-ent.jpg"
                                                         alt="Image description">
                                                    <div class="status-circle bg-primary"></div>
                                                </td>
                                                <td class="img-content-box"><span
                                                        class="d-block">Venter Loren</span><span
                                            ...
                                            <tr>
                                                ...
                                                <td class="img-content-box"><span
                                                        class="d-block">John Loren</span><span class="font-roboto">11:00</span>
                                                </td>
                                                <td>
                ...
                <div class="col-xl-4 xl-50 notification box-col-6">
                    <div class="card">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="media">
                                <div class="media-body">
                                    <p>20-04-2020<span class="ps-1">Today</span><span class="badge badge-secondary">New</span>
                                    </p>
                                ...
                                <div class="media-body">
                                    <div class="d-flex mb-3">
                                        <div class="inner-img"><img class="img-fluid"
                                                                    src="assets/backend/admin/assets/images/notification/1.jpg"
                                                                    alt="Product-1"></div>
                                        <div class="inner-img"><img class="img-fluid"
                                                                    src="assets/backend/admin/assets/images/notification/2.jpg"
                                                                    alt="Product-2"></div>
                                    </div>
                            ...
                            <div class="header-top">
                                ...
                                <div class="card-header-right-icon">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end"
                                             aria-labelledby="dropdownMenuButton"><a class="dropdown-item" href="#">Year</a><a
                    ...
                    <div class="card chat-default">
                        ...
                        <div class="card-body chat-box">
                            <div class="chat">
                                <div class="media left-side-chat">
                                    <div class="media-body d-flex">
                                        <div class="img-profile"><img class="img-fluid"
                                                                      src="assets/backend/admin/assets/images/user.jpg"
                                                                      alt="Profile"></div>
                                        <div class="main-chat">
                                            <div class="message-main"><span class="mb-0">Hi deo, Please send me link.</span>
                                            </div>
                                            <div class="sub-message message-main"><span
                                                    class="mb-0">Right Now</span></div>
                                        </div>
                                    </div>
                                ...
                                <div class="media left-side-chat">
                                    <div class="media-body d-flex">
                                        <div class="img-profile"><img class="img-fluid"
                                                                      ...
                                                                      alt="Profile"></div>
                                        <div class="main-chat">
                                            <div class="sub-message message-main mt-0"><span>It's argently</span>
                                            </div>
                                        </div>
                                    </div>
                                    <p class="f-w-400">7:28 PM</p>
                                ...
                                <div class="media right-side-chat">
                                    <div class="media-body text-end">
                                        <div class="message-main pull-right"><span
                                                class="loader-span mb-0 text-start" id="wave"><span
