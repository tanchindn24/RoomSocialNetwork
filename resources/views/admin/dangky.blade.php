...
<main>
    <section class="content-main">
        <div class="card mx-auto card-login">
            <div class="card-body">
                <h4 class="card-title mb-4">Đăng ký Quản trị</h4>
                <form>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="row gx-2">
                            <div class="col-4"><input class="form-control" value="+84" type="text" /></div>
                            <div class="col-8"><input class="form-control" placeholder="Số điện thoại" type="number" /></div>
                        </div>
                    </div>
                    <!-- form-group// -->
                    <div class="mb-3">
                    ...
                    <!-- form-group// -->
                    <div class="mb-3">
                        <p class="small text-center text-muted">Liên hệ Phòng CTSV để đăng ký quyền admin.</p>
                    </div>
                    <!-- form-group  .// -->
                    <div class="mb-4">
                ...
                <div class="d-flex gap-2 mb-4">
                    <a href="/admin/dangnhap" class="w-50 btn btn-light font-sm">
                ...
                <p class="text-center mb-2"><a href="/admin/dangnhap">Đăng nhập</a></p>
            </div>
        </div>
    </section>
</main>
