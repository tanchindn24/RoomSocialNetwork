...
<html lang="en">
  ...
  <body>
    <div class="x_content">
        <br/>
        <form action="{{ route('admin.nuoctro.nhapsonuoc', ['id'=>$chitiet->id]) }}">
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              <label for="inputPassword4">Giá nước</label>
              <input type="number" class="form-control" name="gianuoc">
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-md-6">
              <label for="inputEmail4">Số nước cũ</label>
              <input type="number" class="form-control" name="sonuoctruoc" value="{{ $sonuoctruoc->sotruoc }}">
            </div>
            <div class="form-group col-md-6">
              <label for="inputPassword4">Số nước mới</label>
              <input type="number" class="form-control" name="sonuocmoi">
            </div>
          </div>
