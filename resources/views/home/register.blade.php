...
<main class="main pages">
    <div class="page-content pt-70 pb-100">
        <div class="container">
            <div class="row">
                        ...
                        <div class="col-lg-5 pr-30 d-none d-lg-block">
                            <div class="card-login mt-115">
                                <a href="#" class="social-login facebook-login">
                                    <img src="{{URL::asset('assets/frontend/imgs/theme/icons/logo-facebook.svg')}}" alt="" />
                                    <span>Continue with Facebook</span>
                                </a>
                                <a href="#" class="social-login google-login">
                                    <img src="{{URL::asset('assets/frontend/imgs/theme/icons/logo-google.svg')}}" alt="" />
