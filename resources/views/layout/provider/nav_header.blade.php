<div class="page-header">
    <div class="header-wrapper row m-0">
        ...
        <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="{{route('provider.index')}}"><img class="img-fluid"
                                                                src="{{URL::asset('assets/backend/provider/assets/images/logo/logo.png')}}"
                                                                alt=""></a></div>
            ...
            <ul class="nav-menus">
                    ...
                    <div class="translate_wrapper">
                        ...
                        <div class="more_lang">
                            ...
                            <div class="lang" data-value="vn"><i class="flag-icon flag-icon-vn"></i><span
                                    class="lang-txt">VietNam</span></div>
                        </div>
                    </div>
                </li>
                ...
                <li class="profile-nav onhover-dropdown p-0 me-0">
                    ...
                    <ul class="profile-dropdown onhover-show-div">
                        ...
                        <li><a href={{ route('provider.logout') }}><i data-feather="log-in"> </i><span>Logout</span></a></li>
                    </ul>
                </li>
            </ul>
        </div>
        <script class="result-template" type="text/x-handlebars-template">
            <div class="ProfileCard u-cf">
                ...
                <div class="ProfileCard-details">
                    <div class="ProfileCard-realName">Provider</div>
                </div>
            </div>
        </script>
