        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <form action="{{route('chutro.loaiphong.add')}}" method="post">
                            @csrf
                            <div class="mb-4">
                                <label for="product_name" class="form-label">Tên</label>
                                <input type="text" placeholder="Type here" class="form-control" name="ten" />
                            </div>
                            <div class="mb-4">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>{{$list->nhatro->count()}}</td>
                                    <td class="text-end">
                                        <div class="dropdown">
                                            <a href="#" data-bs-toggle="dropdown" class="btn btn-light rounded btn-sm font-sm"> <i class="material-icons md-more_horiz"></i> </a>
                                            <div class="dropdown-menu">
                                                @if($list->tinhtrang==1)
                                                    <a class="dropdown-item" href="{{route('loaiphong.unactive', $list->id)}}">khóa</a>
                                                @elseif($list->tinhtrang==2)
                                                    <a class="dropdown-item" href="{{route('loaiphong.active', $list->id)}}">mở</a>
                                                @endif
                                                <a class="dropdown-item" href="{{route('chutro.loaiphong.edit',$list->id)}}">Thay đổi</a>
                                                <a class="dropdown-item text-danger" onclick="return confirm('bạn có muốn xóa loại phòng <{{$list->ten}}> không?');" href="{{route('loaiphong.delete', $list->id)}}">Xóa</a>
                                            </div>
                                        </div>
                                        <!-- dropdown //end -->
                                    </td>
