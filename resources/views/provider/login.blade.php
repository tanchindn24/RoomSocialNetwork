            ...
            <div class="login-card">
                <div>
                    ...
                    <div class="login-main">
                        <form class="theme-form" action="{{ route('provider.login.store') }}" method="post">
                            @csrf
                            ...
                            <p class="mt-4 mb-0 text-center">Don't have account?<a class="ms-2" href="{{ route('provider.register') }}">Create Account</a></p>
                        </form>
                    </div>
                </div>
            </div>
